...
public class UserService implements IDao<User> {
    ...
    public boolean update(User o) {
        String sql = "update user set nom  = ? ,prenom = ? ,role= ? where id  = ?";
        try {
            PreparedStatement ps = Connexion.getInstane().getConnection().prepareStatement(sql);
            ps.setString(1, o.getNom());
            ps.setString(2, o.getPrenom());
    ...
    public User findById(int id) {
        ...
        try {
            ...
            if (rs.next()) {
                return new User(rs.getInt("id"), rs.getString("nom"), rs.getString("prenom"),rs.getString("username"),rs.getString("pass"),rs.getString("role"));
            }
    ...
    public List<User> findAll() {
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                users.add(new User(rs.getInt("id"), rs.getString("nom"), rs.getString("prenom"),rs.getString("username"),rs.getString("pass"),rs.getString("role")));
            }
